  // This is just from https://github.com/stevepapa/ng-autosize,
  // But I couldn't get it to work with npm install, so I just tried to implements
  // As a stand-alone directive.

import { Directive, Input, ElementRef, HostListener, AfterViewInit } from '@angular/core';

@Directive({
  selector: 'textarea[appResize]'
})
